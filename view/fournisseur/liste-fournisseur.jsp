    ...
    <div class="container-fluid">
        <div class="row" style="background-color: #f5f5f5;">
            ...
            <div class="col-sm p-3 min-vh-100">
                <div class="row p-3">
                    <div class="bg-white p-5 rounded-container w-75 mx-auto shadow-sm">
                        <h4 style="font-weight: bold" class="mb-4">Liste des fournisseurs</h4>
                        <table class="table">
                            <thead>
                                <tr>
                                <th scope="col">Nom</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row"><%=fournisseur.getNom() %></th>
                                    <td><%=fournisseur.getMail() %></td>
                                    <td><a href="/commercial/proforma/detail.do?fournisseur=<%=fournisseur.getId() %>" class="btn">Proforma</a></td>
                                </tr>
                                <% } %>
                            </tbody>
                        </table>
