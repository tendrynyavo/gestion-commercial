...
<head>
    ...
    <title>Liste demande de Proforma</title>
</head>
<body>
                ...
                <div class="row p-3">
                    <div class="col">
                        <div class="bg-white p-5 rounded-container shadow-sm">
                            <h4 style="font-weight: bold" class="mb-4">Detail de la demande du <%=demande.getDateDemande() %></h4>
                            <form action="/commercial/demande/ajout-produit-proforma.do" method="POST">
                                <div class="mb-4 row">
